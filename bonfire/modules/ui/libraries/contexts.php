...
class Contexts
{
	...
	private static function build_item($module, $title, $display_name, $context, $menu_view='')
	{
		if (empty($menu_view))
		{
            ...
            if($context == strtolower('resources')) { // TODO: find out where is the context items are located
                if($module == strtolower('returned_items')) {
                    $item = "";
                }
            }
            if($context == strtolower('users')) { // TODO: find out where is the context items are located
                if($module == strtolower('users')) {
                    $item = "";
                }
            }
		}
