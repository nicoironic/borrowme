...
<style>body { background: rgb(27, 112, 27); }</style>
<div id="logo">

</div>
<div id="login">
    <div class="left" style="text-align: center;">
        <img src="<?php echo Template::theme_url('images/logo.jpg'); ?>">
    </div>
    <div class="right">
        ...
        <div class="control-group">
            <div class="controls">
                <input class="btn btn-large btn-success" type="submit" name="log-me-in" id="submit" value="<?php e(lang('us_let_me_in')); ?>" tabindex="5" />
            </div>
        </div>
        <?php echo form_close(); ?>
