...
class Migration_Install_subjects_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Subjects.Resources.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Subjects.Resources.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Subjects.Resources.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Subjects.Resources.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
