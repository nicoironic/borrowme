...
class Migration_Install_purchase_order_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Purchase_Order.Orders.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Order.Orders.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Order.Orders.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Purchase_Order.Orders.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
