...
class Migration_Install_laboratories_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Laboratories.Resources.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Laboratories.Resources.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Laboratories.Resources.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Laboratories.Resources.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
