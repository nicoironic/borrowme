...
class Migration_Install_teachers_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Teachers.Users.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Teachers.Users.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Teachers.Users.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Teachers.Users.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
