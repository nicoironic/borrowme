...
class Migration_Install_sales_order_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Sales_Order.Orders.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Sales_Order.Orders.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Sales_Order.Orders.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Sales_Order.Orders.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
