...
$num_columns	= 7;
$can_delete	= $this->auth->has_permission('Returned_Items.Resources.Delete');
$can_edit		= $this->auth->has_permission('Returned_Items.Resources.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/resources/returned_items/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->worker_id); ?></td>
				<?php else : ?>
