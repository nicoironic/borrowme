...
class Migration_Install_students_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Students.Users.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Students.Users.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Students.Users.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Students.Users.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
